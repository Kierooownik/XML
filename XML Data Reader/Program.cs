...
namespace XML_Data_Reader
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string materialNumber = referenceParameters[65501].Value;
            string outputPath = Path.Combine(folderPath, $"SAP{materialNumber}_XML_Compare_{currentDateTime}.xlsx");
            //string outputPathSAP = $"{outputPath}_SAP{materialNumber}.xlsx";
